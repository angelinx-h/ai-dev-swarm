...
Stage mapping:
- 0 or 00 or init-ideas → Use agent skill `dev-swarm-init-ideas`
- 1 or 01 or market-research → Use agent skill `dev-swarm-market-research`
- 2 or 02 or personas → Use agent skill `dev-swarm-personas`
- 3 or 03 or mvp → Use agent skill `dev-swarm-mvp`
- 4 or 04 or prd → Use agent skill `dev-swarm-prd`
- 5 or 05 or ux → Use agent skill `dev-swarm-ux`
- 6 or 06 or architecture → Use agent skill `dev-swarm-architecture`
- 7 or 07 or tech-specs → Use agent skill `dev-swarm-tech-specs`
- 8 or 08 or devops → Use agent skill `dev-swarm-devops`
- 9 or 09 or sprints → Use agent skill `dev-swarm-project-management`
- 10 or deployment → Use agent skill `dev-swarm-deployment`
- 99 or archive → Use agent skill `dev-swarm-project-archive`
