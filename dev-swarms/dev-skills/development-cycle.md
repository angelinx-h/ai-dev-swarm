...
When creating sprints and backlogs, the project manager should follow the rules defined in `dev-swarms/docs/sprint-backlog-guidelines.md` (include this file in the skill.md file as a required reference, so we can update the rules at any time).
