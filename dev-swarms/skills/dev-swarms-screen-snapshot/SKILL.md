---
name: dev-swarms-screen-snapshot
...
1.  **Start the Screen Stream Process**:
    ...
    ```bash
    uv run --directory {PROJECT-ROOT}/dev-swarms/py_scripts screen_stream.py --monitor -1 --background --fps 30 --host 127.0.0.1 --port 9090
    ```
