---
name: dev-swarms-create-update-agent-skill
...
This skill helps you create new agent skills or update existing ones following the Agent Skills specification and dev-swarms conventions.
...
1. **Ask the user for clarification if needed:**
   - What is the skill name? (must start with `dev-swarms-`, lowercase, hyphens only)
...
2. **Review reference materials:**
   ...
   - See [references/dev-swarms-roles.md](references/dev-swarms-roles.md) for available roles and their responsibilities
...
1. Create the skill directory: `dev-swarms/skills/dev-swarms-{skill-name}/`
...
1. Locate the existing skill directory: `dev-swarms/skills/dev-swarms-{skill-name}/`
...
```yaml
---
name: dev-swarms-skill-name
description: A clear description of what this skill does and when to use it.
---
```

**Frontmatter requirements:**
- `name`: Must start with `dev-swarms-`, match directory name, lowercase, hyphens only, max 64 characters
...
Choose roles from [references/dev-swarms-roles.md](references/dev-swarms-roles.md):
- Product Manager
...
- **Appropriate roles**: Choose roles that match the task from [dev-swarms-roles.md](references/dev-swarms-roles.md)
...
- **Naming convention**: All skill names must start with `dev-swarms-`
...
**Issue: Skill name doesn't start with dev-swarms-**
- Solution: All dev-swarms skills must be named `dev-swarms-{skill-name}`
