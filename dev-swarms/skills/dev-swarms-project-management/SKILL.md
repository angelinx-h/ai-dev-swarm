...
1. `dev-swarms/docs/what-is-a-feature.md` (Feature Definition)
2. `dev-swarms/docs/sprint-backlog-guidelines.md` (AI-Driven Development Sprint & Backlog Guidelines)
...
1. **FEATURE** - A new feature request (initial development). Matches `dev-swarms/docs/what-is-a-feature.md`.
...
**CRITICAL:** A Backlog Item is a **FEATURE**. Refer to `dev-swarms/docs/what-is-a-feature.md`.
...
3.  **Testability (The Definition of Done):**
    ...
    *   Follow `dev-swarms/docs/sprint-backlog-guidelines.md`.
