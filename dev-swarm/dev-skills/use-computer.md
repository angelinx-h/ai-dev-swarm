Refer to dev-swarm/py_scripts/screen_stream.py and dev-swarm/skills/dev-swarm-screen-snapshot/SKILL.md. Create a use computer skill by creating a Python script at dev-swarm/py_scripts/use_computer.py using the packages `pyautogui` and `screeninfo`.
